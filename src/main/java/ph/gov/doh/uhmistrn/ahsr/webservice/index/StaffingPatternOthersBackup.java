 ...
 *         &lt;element name="parent" type="{http://www.w3.org/2001/XMLSchema}string" form="unqualified"/>
...
@XmlRootElement(name = "staffingPatternOthers")
public class StaffingPatternOthersBackup {
