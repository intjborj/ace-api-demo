...
public class HospOptDischargesEV {
    ...
    @XmlElement(required = true, nillable = true)
    protected String evtofacilityfromanother;
     ...
     *     
     */
    public String getEvtofacilityfromanother() {
        return evtofacilityfromanother;
    }
    ...
    public void setEvtofacilityfromanother(String value) {
        this.evtofacilityfromanother = value;
    }
