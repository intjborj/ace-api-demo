...
BEGIN
		...
		WITH stockcard as(
		    ...
		    where a.item = itemId and a.document_types IN ('254a07d3-e33a-491c-943e-b3fe6792c5fc', '0caab388-e53b-4e94-b2ea-f8cc47df6431', 'af7dc429-8352-4f09-b58c-26a0a490881c', '27d236bb-c023-44dc-beac-18ddfe1daf79')
			--document Types (SRR, BEG, EP, MP)
		    group BY
		    a.id,
		    a.source_dep,
		    b.department_name,
		    ...
		    a.ledger_qty_out,
		    a.ledger_unit_cost
		)SELECT Unitcost as last_unit_cost FROM stockcard where
		date(ledger_date) <= filterDate ORDER BY ledger_date DESC LIMIT 1);
