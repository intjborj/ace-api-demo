...
AND c.discharge_condition::text = 'EXPIRED'::text
and d.value ->> 'causeOfDeath'::text = 'Primary-Underlying'
 and  COALESCE((d.value ->> 'isRespiratoryArrest'::text)::BOOLEAN, FALSE) = FALSE
