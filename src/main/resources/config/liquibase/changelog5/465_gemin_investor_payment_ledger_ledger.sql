...
ALTER TABLE "billing"."investor_payment_ledger"
    ...
    ADD COLUMN payment_tracker                                   uuid NOT NULL
                                                                 constraint fk_investor_payment_ledger_payment_tracker_id
                                                                 references cashiering.payment_tracker(id)
...
ALTER TABLE "billing"."investor_payment_ledger"
        ...
        DROP COLUMN IF EXISTS date_deposited,
        DROP COLUMN IF EXISTS date_cleared,
        DROP COLUMN IF EXISTS subscription_number,
        DROP COLUMN IF EXISTS reference_number,
        DROP COLUMN IF EXISTS acquiring_bank,
        DROP COLUMN IF EXISTS depository_bank;
