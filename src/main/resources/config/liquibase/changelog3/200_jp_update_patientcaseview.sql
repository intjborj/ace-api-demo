CREATE OR REPLACE VIEW pms.patient_case_view
  ...
  GROUP BY p.id, c.id, c.status, c.discharge_condition, c.discharge_disposition, e.first_name, e.last_name, e.id, m."position", c.admission_datetime, c.transferred_in, c.transferred_out, c.registry_type, c.may_go_home_datetime, c.room, c.service_type, c.transfer_hci, c.discharged_datetime, c.originating_hci, c.diet
