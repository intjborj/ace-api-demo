...
@Entity
@Table(name = "discharge_specialty_others", schema = "doh")
class HospOptDischargeSpecialtyOthers extends AbstractAuditingEntity{
    @GraphQLQuery
    @Id
    ...
    @GraphQLQuery
    @Column(name = "other_type_services_specify", columnDefinition = "varchar")
    String otherTypeServicesSpecify

    @GraphQLQuery
    @Column(name = "no_patients", columnDefinition = "numeric")
    Integer noPatients
    ...
    @GraphQLQuery
    @Column(name = "non_philhealth_pay", columnDefinition = "numeric")
    Integer nonPhilHealthPay

    @GraphQLQuery
    @Column(name = "nph_service_charity", columnDefinition = "numeric")
    ...
    @GraphQLQuery
    @Column(name = "philhealth_services", columnDefinition = "numeric")
    Integer philHealthServices
    ...
    @GraphQLQuery
    @Column(name = "death_below_48_hours", columnDefinition = "numeric")
    Integer deathBelow48Hours

    @GraphQLQuery
    @Column(name = "death_over_48", columnDefinition = "numeric")
    Integer deathOver48
