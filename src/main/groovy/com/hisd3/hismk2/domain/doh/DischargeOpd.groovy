...
@Entity
@Table(name = "discharge_opd", schema = "doh")
class DischargeOpd extends AbstractAuditingEntity{
    @GraphQLQuery
    @Id
    ...
    @GraphQLQuery
    @Column(name = "opd_consultation", columnDefinition = "varchar")
    String opdConsultation
