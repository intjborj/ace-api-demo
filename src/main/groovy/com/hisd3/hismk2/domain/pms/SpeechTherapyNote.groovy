...
@javax.persistence.Table(schema = "pms", name= "speech_therapy_notes")
@SQLDelete(sql = "UPDATE pms.speech_therapy_notes SET deleted= true WHERE id = ?", check = ResultCheckStyle.COUNT)
@Where(clause = "deleted <> true or deleted is  null ")
class SpeechTherapyNote extends AbstractAuditingEntity {
