...
@javax.persistence.Table(schema = "pms", name= "physical_therapy_notes")
@SQLDelete(sql = "UPDATE pms.physical_therapy_notes SET deleted= true WHERE id = ?", check = ResultCheckStyle.COUNT)
@Where(clause = "deleted <> true or deleted is  null ")
class PhysicalTherapyNote extends AbstractAuditingEntity implements Serializable {
