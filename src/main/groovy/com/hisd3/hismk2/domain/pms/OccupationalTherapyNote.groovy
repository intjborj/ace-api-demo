...
@javax.persistence.Table(schema = "pms", name= "occupational_therapy_notes")
@SQLDelete(sql = "UPDATE pms.occupational_therapy_notes SET deleted= true WHERE id = ?", check = ResultCheckStyle.COUNT)
@Where(clause = "deleted <> true or deleted is  null ")
class OccupationalTherapyNote extends AbstractAuditingEntity {
