 ...
 *         &lt;element name="opdconsultations" type="{http://www.w3.org/2001/XMLSchema}string" form="unqualified"/>
...
@XmlRootElement(name = "hospOptDischargesOPD")
public class HospOptDischargesOPD {

    @XmlElement(required = true, nillable = true)
    protected String hfhudcode;
    @XmlElement(required = true, nillable = true)
    protected String opdconsultations;
    @XmlElement(required = true, nillable = true)
    ...
    /**
     * Gets the value of the opdconsultations property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getOpdconsultations() {
        return opdconsultations;
    }

    /**
     * Sets the value of the opdconsultations property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setOpdconsultations(String value) {
        this.opdconsultations = value;
    }
