 ...
 *         &lt;element name="othertypeofservicespecify" type="{http://www.w3.org/2001/XMLSchema}string" form="unqualified"/>
...
@XmlRootElement(name = "hospOptDischargesSpecialtyOthers")
public class HospOptDischargesSpecialtyOthers {

    @XmlElement(required = true, nillable = true)
    protected String hfhudcode;
    @XmlElement(required = true, nillable = true)
    protected String othertypeofservicespecify;
    @XmlElement(required = true, nillable = true)
    ...
    /**
     * Gets the value of the othertypeofservicespecify property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getOthertypeofservicespecify() {
        return othertypeofservicespecify;
    }

    /**
     * Sets the value of the othertypeofservicespecify property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setOthertypeofservicespecify(String value) {
        this.othertypeofservicespecify = value;
    }
